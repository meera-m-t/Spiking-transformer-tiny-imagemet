...
ImageNet_trainLoader = DataLoader(trainset, batch_size=len(trainset),shuffle=True,  num_workers=4)

valset = utils.CacheDataset(torchvision.datasets.ImageFolder('tiny-224/val',  transform=s1c1))
ImageNet_valLoader = DataLoader(valset, batch_size=len(valset), shuffle=True,  num_workers=4)         



mozafari = CvT(2, 100, 200, (50,50), 1000, (0.0001, -0.0035), (-0.0001, 0.00006), 0.5)
if use_cuda:
    mozafari.cuda()
